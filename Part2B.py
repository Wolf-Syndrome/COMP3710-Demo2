...
trainset = torchvision.datasets.CIFAR10(root=path+'data/CIFAR10', train=True, download=True, transform=transform_train)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True)

testset = torchvision.datasets.CIFAR10(root=path+'data/CIFAR10', train=False, download=True, transform=transform_test)
